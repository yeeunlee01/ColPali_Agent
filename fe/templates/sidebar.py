...
def get_sidebar_template():
    ...
    <!-- 진행 상황 섹션 -->
    <div id="progressSection" class="hidden p-4 border-b border-gray-200">
        <div class="mb-2">
